...
****
[.tile]
.Downloading TED Notices for Data Reusers
****
Bulk downloads of notices in xml fomat are offered by the TED Portal; daily or monthly packages are available. Bulk downloads in xml format can be retrieved by query via the Search API. Notices in other file formats can be downloaded via direct links. 

<<bulkdownloads:ROOT:index.adoc#, Read the docs>>
****
--
